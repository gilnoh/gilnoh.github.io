...
[^1]: It seems different models have different default "current season" priors when temporal information is missing. In my early-2026 tests, GPT-4.1 leaned "spring" (and flipped to "autumn" when the location was Sydney), while GPT-5.2 leaned "winter" (and flipped to "summer" with Sydney). This suggests model-specific, cutoff-anchored temporal priors.
